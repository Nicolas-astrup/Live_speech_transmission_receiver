...
class bpsk_file_transfer_loopback2_Pluto(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, MTU=1500, frame_size=6):
        ...
        self._sym_bw_range = qtgui.Range(0.01, 0.09, 0.001, 0.045, 200)
        ...
        self._excess_bw_range = qtgui.Range(0.1, 0.6, 1, 0.3, 200)
        ...
        self._costas_bw_range = qtgui.Range(0.01, 0.6, 0.01, 0.2, 200)
        ...
        self.filter_fft_rrc_filter_1 = filter.fft_filter_ccc(1, firdes.root_raised_cosine(1, samp_rate, (samp_rate/sps), excess_bw, 88), 1)
        ...
        self.blocks_vector_source_x_0_0 = blocks.vector_source_b([192, 175], True, 1, [])
        ...
        self._QT_gain_range = qtgui.Range(0, 73, 1, 10, 200)
        ...
        self.connect((self.codec2488_0, 0), (self.digital_crc32_bb_0, 0))
        ...
        self.connect((self.filter_fft_rrc_filter_1, 0), (self.filter_fft_rrc_filter_0, 0))
        self.connect((self.filter_fft_rrc_filter_1, 0), (self.qtgui_time_sink_x_0_0, 0))
    ...
    def set_sps(self, sps):
        ...
        self.filter_fft_rrc_filter_1.set_taps(firdes.root_raised_cosine(1, self.samp_rate, (self.samp_rate/self.sps), self.excess_bw, 88))
